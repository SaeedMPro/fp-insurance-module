...
def build():
    ...
    para(doc,
         "رابط برنامه‌نویسی سامانه شامل سی مسیر و سی‌وهشت عملیات است و به‌صورت رسمی در یک "
    ...
    para(doc,
         ...
         "بررسی، تأیید، رد، بازگرداندن برای مدارک، ثبت پرداخت، بستن پرونده، و تغییر "
         "پیکربندی قواعد. برای هر رویداد، کاربر، زمان و مقدار قبل و بعد نگه‌داری می‌شود.")
    para(doc,
    ...
    heading(doc, "۶.۵. رابط کاربری فارسی", 2)
    para(doc,
         "رابط کاربری شامل شانزده صفحه و به‌طور کامل فارسی و راست‌به‌چپ است. تاریخ‌ها با "
    ...
    para(doc,
         ...
         "توسط مدیر و راستی‌آزمایی این‌که درخواست بعدی با نرخ جدید محاسبه می‌شود، بررسی "
         "محدودیت‌های دسترسی، و صحت لاگ ممیزی و گزارش‌ها.")
    para(doc,
