...
def build():
    ...
    table(doc,
          ...
          [
              ...
              ["saeed.mazahery", "Employee123!‎", "کارمند — طرح استاندارد"],
              ["farzin.hamzei", "Employee123!‎", "کارمند — طرح ویژه"],
    ...
    table(doc,
          ...
          [
              ...
              ["backend/cmd/createadmin", "ساخت حساب مدیر سامانه"],
              ["backend/db", "شِمای پایگاه داده (init.sql) و داده نمونه (seed.sql)"],
              ...
              ["backend/internal/platform", "زیرساخت: پیکربندی، ذخیره فایل، ثبت وقایع"],
              ["backend/internal/app", "محل سیم‌کشی وابستگی‌ها"],
              ...
              ["scripts/", "اجرای محلی سامانه بدون Docker"],
              ["docker-compose.yml", "تنظیمات استقرار"],
              ["docs/", "مستندات پروژه"],
          ],
          widths=[6.0, 9.0])
